...
// Define the interface for the props we will pass in
export interface TourCardProps {
    ...
    imageSrc: string;
    imageAlt: string;
    imagePosition?: "left" | "right"; // Determines side-by-side layout
    cardTitle: string;
            ...
            <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-tour-white mb-8 tracking-tight">
                        {titlePrefix} <span className="text-tour-green">{titleHighlight}</span>
                    </h2>
                ...
                <motion.div
                    ...
                    viewport={{ once: true, margin: "-100px" }}
                    className={`w-full bg-tour-dark-green rounded-3xl overflow-hidden shadow-2xl flex flex-col border border-white/5 ${imagePosition === "right" ? "lg:flex-row-reverse" : "lg:flex-row"
                        }`}
                >
                    {/* Image Container */}
                        ...
                        >
                            ...
                            <motion.ul className="space-y-4">
                                {benefits.map((benefit, index) => (
                                    ...
                                    >
                                        <CheckCircle2
                                            className="w-5 h-5 text-tour-green flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform"
                                            strokeWidth={2}
                                        />
