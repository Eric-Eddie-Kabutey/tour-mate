                        ...
                        >
                            ...
                            <div className="p-4 space-y-4">
                                ...
                                <div className="flex gap-2">
                                    <button className="flex-1 py-2 text-sm font-medium border border-gray-200 rounded-md hover:bg-gray-50 text-center">
                                        Sign In
                                    </button>
                                    <button className="flex-1 py-2 text-sm font-medium bg-tour-green text-tour-white rounded-md hover:bg-[#048417] text-center">
                                        Sign Up
                                    </button>
                                </div>
